...
public class SuggestionActivity extends AppCompatActivity {
    ...
    String ServerUploadPath ="http://192.168.56.1/android_login_api/img_upload_to_server.php" ;
    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(SuggestionActivity.this,"Image is Uploading","Please Wait",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(SuggestionActivity.this,string1,Toast.LENGTH_LONG).show();
